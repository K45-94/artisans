...
export declare type Feature = (UseIdentityPasswordRegister | UseIdentityPasswordRegisterBaseConfig) | (UseIdentityPasswordLogin | UseIdentityPasswordLoginBaseConfig) | (UseIdentityPasswordLogout | UseIdentityPasswordLogoutBaseConfig) | (UseUnauthenticatedRedirector | UseUnauthenticatedRedirectorBaseConfig) | (UseAuthenticatedRedirector | UseAuthenticatedRedirectorBaseConfig) | (UseHandlesErrors | UseHandlesErrorsBaseConfig) | (UseFetchUser | UseFetchUserBaseConfig) | (UseAuthState | UseAuthStateBaseConfig) | (UseAuthRedirector | UseAuthRedirectorBaseConfig) | (UsePasswordResetViaEmail | UsePasswordResetViaEmailBaseConfig) | (UseUpdatePassword | UseUpdatePasswordBaseConfig);
